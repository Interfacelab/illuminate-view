...
namespace ILAB_Illuminate\View\Compilers;
...
class BladeCompiler extends Compiler implements CompilerInterface
{
    ...
    public function if($name, callable $callback)
    {
        ...
        $this->directive($name, function ($expression) use ($name) {
            return $expression
                    ? "<?php if (\ILAB_Illuminate\Support\Facades\Blade::check('{$name}', {$expression})): ?>"
                    : "<?php if (\ILAB_Illuminate\Support\Facades\Blade::check('{$name}')): ?>";
        });
